...
Revision ID: 83af2fd4fef5
Revises: 
Create Date: 2025-08-05 20:10:15.173397
...
def upgrade() -> None:
    ...
    sa.Column('centro_treinamentos_id', sa.Integer(), nullable=False),
    sa.Column('id', sa.UUID(), nullable=False),
    sa.ForeignKeyConstraint(['categoria_id'], ['categorias.pk_id'], ),
    sa.ForeignKeyConstraint(['centro_treinamentos_id'], ['centros_treinamento.pk_id'], ),
    sa.PrimaryKeyConstraint('pk_id'),
